generateIdentityCard = async function(){
  ...
  try{
    ...
    wrap.innerHTML=`<img src="${d.card_url}" alt="TYPE ME 人格身份证" style="width:100%;border-radius:18px;display:block" loading="eager"><a id="saveCardLink" class="secondary-btn" href="${d.card_url}" download="${filename}" style="text-align:center;text-decoration:none">保存人格身份证 PNG</a>`;
